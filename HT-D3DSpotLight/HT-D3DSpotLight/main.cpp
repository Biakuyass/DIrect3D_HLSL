...
HRESULT CALLBACK OnD3D9CreateDevice(LPDIRECT3DDEVICE9 pd3dDevice,const D3DSURFACE_DESC *pBackBufferSurfacfeDesc,void *pUserText)
{
	...
	g_Sphere1.OnD3D9CreateDevice(pd3dDevice,L"Model.X",L"SpotLight.fx",L"ColorMap.bmp");
/*	g_Sphere2.OnD3D9CreateDevice(pd3dDevice,L"ResFile_4_Ball_2\\Model.X",L"SpotLight.fx",L"ResFile_4_Ball_2\\ColorMap.bmp");
	g_Sphere3.OnD3D9CreateDevice(pd3dDevice,L"ResFile_5_Ball_3\\Model.X",L"SpotLight.fx",L"ResFile_5_Ball_3\\ColorMap.bmp");
	g_Sphere4.OnD3D9CreateDevice(pd3dDevice,L"ResFile_6_Ball_4\\Model.X",L"SpotLight.fx",L"ResFile_6_Ball_4\\ColorMap.bmp");
	g_Ground.OnD3D9CreateDevice(pd3dDevice,L"ResFile_1_Ground\\Model.X",L"SpotLight.fx",L"ResFile_1_Ground\\ColorMap.jpg");*/
...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
	...
	D3DXVECTOR4 vLightDirection(-5,-6,0,0);
...
//	D3DXMatrixRotationY(&g_matWorld,fTime/10.0f);
	...
	g_Sphere1.OnFrameMove(fTime,fElapsedTime,&g_matWorld,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
	/*g_Sphere2.OnFrameMove(fTime,fElapsedTime,&g_matWorld,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
	g_Sphere3.OnFrameMove(fTime,fElapsedTime,&g_matWorld,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
	g_Sphere4.OnFrameMove(fTime,fElapsedTime,&g_matWorld,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
	g_Ground.OnFrameMove(fTime,fElapsedTime,&g_matWorld,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
	*/

	mWorldViewProj=g_matLightPosition*mView*mProj;
	g_Light.OnFrameMove(fTime,fElapsedTime,&g_matLightPosition,&mWorldViewProj,&mWorldInverseTranspose,&vEye,&vLight,&vLightDirection);
