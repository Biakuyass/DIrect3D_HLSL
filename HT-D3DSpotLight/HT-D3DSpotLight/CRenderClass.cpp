...
HRESULT CRenderObject::OnD3D9CreateDevice(LPDIRECT3DDEVICE9 pd3dDevice,wchar_t* chXFilename,wchar_t* chEffectname,wchar_t* chTexturename)
{
	...
	V_RETURN(D3DXLoadMeshFromX(chXFilename,D3DXMESH_SYSTEMMEM,pd3dDevice,0,&pMaterial,0,0,&pMeshClone));
	...
	//材质
	memcpy(&m_Material,pMaterial->GetBufferPointer(),sizeof(D3DXMATERIAL));
...
void  CRenderObject:: OnFrameMove( double fTime, float fElapsedTime,D3DXMATRIX* pmatWorld,D3DXMATRIX* pmWorldViewProj ,D3DXMATRIX* pmatWorldInverseTranspose,D3DXVECTOR4* pvEye,D3DXVECTOR4* pvLight,D3DXVECTOR4 *pvLightDirection)
{
	HRESULT hr;
	//矩阵设置
//	D3DXMATRIX mWorld=matWorld;
	...
	V(m_Effect->SetMatrix("matWorldInverseTranspose",pmatWorldInverseTranspose));
	V(m_Effect->SetVector("EyePosition",pvEye));
	V(m_Effect->SetVector("LightPosition",pvLight));
	V(m_Effect->SetVector("vLightDirection",pvLightDirection));

	D3DXMATRIX matMaterial;

	matMaterial._11 = m_Material.MatD3D.Ambient.r ;
	matMaterial._12 = m_Material.MatD3D.Ambient.g ;
	matMaterial._13 = m_Material.MatD3D.Ambient.b ;
	matMaterial._14 = m_Material.MatD3D.Ambient.a ;
	//
	matMaterial._21 = m_Material.MatD3D.Diffuse.r  ;
	matMaterial._22 = m_Material.MatD3D.Diffuse.g ;
	matMaterial._23 = m_Material.MatD3D.Diffuse.b ;
	matMaterial._24 = m_Material.MatD3D.Diffuse.a ;
	//
	matMaterial._31 = m_Material.MatD3D.Specular.r ;
	matMaterial._32 = m_Material.MatD3D.Specular.g ;
	matMaterial._33 = m_Material.MatD3D.Specular.b ;
	matMaterial._34 = m_Material.MatD3D.Specular.a ;

	m_Effect->SetMatrix("material",&matMaterial);
