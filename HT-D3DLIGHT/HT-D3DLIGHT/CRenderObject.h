...
public :
    ...
    void OnFrameMove( double fTime, float fElapsedTime,D3DXMATRIX* pmatWorld,D3DXMATRIX* pmWorldViewProj ,D3DXMATRIX* pmatWorldInverseTranspose,D3DXVECTOR4* pvEye,D3DXVECTOR4* pvLight);
