...
VS_OUTPUT RenderSceneVS(VS_INPUT input)
{
	...
	//Output.TextureUV.x=input.TextureUV.x/1+(float)0/g_iScaleX;
	//Output.TextureUV.y=input.TextureUV.y/1+(float)0/g_iScaleY;
...
PS_OUTPUT RenderScenePS(VS_OUTPUT input)
{
	...
	Output.Color=tex2D(MeshTexture,input.TextureUV);//*float4(0.3,1.0,0,1.0)
