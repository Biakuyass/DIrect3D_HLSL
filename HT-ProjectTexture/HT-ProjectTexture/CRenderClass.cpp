...
#define PIXELNUM (256*256)
	...
	LockRect.Pitch=PIXELNUM*sizeof(int)/4;
...
void CRenderObject::SetProject(D3DXMATRIX* pWorld,D3DXMATRIX * pWorldViewProjProject)
{
	m_Effect->SetMatrix("matWorldViewProjProject",pWorldViewProjProject);
