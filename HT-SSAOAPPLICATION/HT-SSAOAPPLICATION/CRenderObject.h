...
public :
	...
	LPDIRECT3DTEXTURE9 ReturnDepthTexture(){return m_pRTTTextureDepth;}
	LPDIRECT3DTEXTURE9 ReturnSSAOTexture(){return m_pSSAOTexture;}
	void SetSSAOTexture(LPDIRECT3DTEXTURE9 Texture_){m_pSSAOTexture=Texture_;m_Effect->SetTexture("g_SSAOTexture",m_pSSAOTexture);}
