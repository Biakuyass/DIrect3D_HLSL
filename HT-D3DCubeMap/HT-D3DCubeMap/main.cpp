...
HRESULT CALLBACK OnD3D9CreateDevice(LPDIRECT3DDEVICE9 pd3dDevice,const D3DSURFACE_DESC *pBackBufferSurfacfeDesc,void *pUserText)
{
	...
	g_CubeMap.OnD3D9CreateDevice(pd3dDevice,L"Model.X",L"CubeMap.fx",NULL,L"LobbyCube.dds");
	g_ReflectObject.OnD3D9CreateDevice(pd3dDevice,L"ModelReflect.X",L"Reflect.fx",NULL,L"LobbyCube.dds");
